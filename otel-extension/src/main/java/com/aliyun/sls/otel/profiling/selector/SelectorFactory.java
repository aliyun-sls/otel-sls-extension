...
public enum SelectorFactory {
     ...
     *
     * @param profilingConfig profiling config
     * @return profiling selector
     */
    public ProfilingSelector buildProfilingSelector(ProfilingConfig profilingConfig) {
        ProfilingCountLimitSelector profilingCountLimitSelector = new ProfilingCountLimitSelector(profilingConfig.getMaxProfilingCount());
